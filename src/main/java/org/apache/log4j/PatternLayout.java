 ...
 * e end of a conversion specifier when it reads a conversion
 * aracter. In the example above the conversion specifier
 * >%-5p</b> means the priority of the logging event should be left
 * stified to a width of five characters.
 * <p>
 * e recognized conversion characters are
 * <p>
 * >
